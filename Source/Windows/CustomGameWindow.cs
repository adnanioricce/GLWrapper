...
namespace GLWrapper
{
    public class CustomGameWindow : OpenTK.GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            LogExtensions.LogGLError(this.GetType().Name, nameof(OnUpdateFrame));
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            _vertexArrays.ForEach(vao =>
            {
                ...
                vao.Shaders.ForEach(shader => {
                    ...
                    shader.SetFloat("u_time",(float)e.Time);
                    GL.DrawArraysInstanced(PrimitiveType.TriangleStrip, 0, 36, 100);
                });                
            });
            Context.SwapBuffers();
